...
int main()
{
    ...
    GraphLib::Graph g3 = g1 + g2; // Add the two graphs together.
    ...
    g1 /= -2;
    GraphLib::Graph g4 = g1 * g2; // Multiply the two graphs together.
    ...
    try
    {
        GraphLib::Graph g6 = g5 * g1; // Multiply the two graphs together.
    }
